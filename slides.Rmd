...
\small
* \alert{packagename.Rproj}: This indicates that the directory is a project
* \alert{DESCRIPTION}: This is where all the meta-data about your package goes -- you can edit this file manually 
* \alert{NAMESPACE}: This file indicates what needs to be exposed to users for your R package -- we will recreate this file using `document()` (see next slide)
* \alert{R}: This is where all your R code goes for your package
* \alert{man}: This is where the manuals for your functions will be saved
